...
BEGIN
    ...
    IF completada=0 THEN
        ...
        END IF;
        IF EXISTS (
            SELECT 1 FROM cursos c INNER JOIN usuarios u ON u.idUsuario=c.responsable
            ...
            SELECT 1 FROM secciones s INNER JOIN cursos c ON c.idCurso=s.id_curso INNER JOIN usuarios u ON u.idUsuario=s.docente
            ...
            SELECT 1 FROM secciones s INNER JOIN cursos c ON c.idCurso=s.id_curso INNER JOIN usuarios u ON u.idUsuario=s.tutor
            ...
            SELECT 1 FROM asignacioncursos a INNER JOIN cursos c ON c.idCurso=a.id_seccion INNER JOIN usuarios u ON u.idUsuario=a.id_estudiante
            ...
            SELECT 1 FROM mensajes m INNER JOIN usuarios u ON u.idUsuario=m.id_remitente
            ...
            SELECT 1 FROM mensajes m INNER JOIN usuarios u ON u.idUsuario=m.id_destinatario
            ...
            SELECT 1 FROM mensajes_participantes mp INNER JOIN mensajes m ON m.idMensaje=mp.id_mensaje INNER JOIN usuarios u ON u.idUsuario=mp.id_usuario
            ...
            SELECT 1 FROM notificaciones n INNER JOIN usuarios u ON u.idUsuario=n.id_usuario
            ...
            SELECT 1 FROM notificaciones_lecturas nl INNER JOIN usuarios u ON u.idUsuario=nl.id_usuario
            ...
            SELECT 1 FROM actividades a INNER JOIN usuarios u ON u.idUsuario=a.id_autor
            ...
            SELECT 1 FROM evaluaciones e INNER JOIN cursos c ON c.idCurso=e.id_curso INNER JOIN usuarios u ON u.idUsuario=e.id_autor
            ...
            SELECT 1 FROM entregaslecciones e INNER JOIN cursos c ON c.idCurso=e.id_curso INNER JOIN usuarios u ON u.idUsuario=e.id_estudiante
            ...
            SELECT 1 FROM calificaciones n INNER JOIN cursos c ON c.idCurso=n.id_curso INNER JOIN usuarios u ON u.idUsuario=n.id_estudiante
            ...
            SELECT 1 FROM posteos p INNER JOIN cursos c ON c.idCurso=p.id_curso INNER JOIN usuarios u ON u.idUsuario=p.id_autor
